...
def main():
    ...
    patched_pkl_root = "/nfs/turbo/umms-tocho-snr/exp/chengjia/madeleine_patch/all/segmentation/pkl/"
    ...
    already_patched = os.listdir(patched_pkl_root)
    already_patched = [
        i.removesuffix("_tissue_mask.pkl") for i in already_patched
