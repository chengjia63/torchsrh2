...
class DataAugmentationDINO(object):
    ...
    def __call__(self, image):
        ...
        # local crops:
        local_crops = [
            torch.nan_to_num(self.local_transfo(
                self.geometric_augmentation_local(image)),
                             nan=0) for _ in range(self.local_crops_number)
        ]
...
class TileDataAugmentationDINO(DataAugmentationDINO):
    ...
    def __init__(self, tile_height=48, tile_width=48, **kwargs):
